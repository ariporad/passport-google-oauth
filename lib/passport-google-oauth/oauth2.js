...
Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.redirect_url || options.redirect_uri){
    // This Paramater Is For Overiding The Redirect Url 
    params['redirect_uri'] = options.redirect_url || options.redirect_uri;
  }
